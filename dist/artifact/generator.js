...
export class ArtifactGenerator {
    ...
    async createPullRequest(testReport, beadsAudit) {
    ...
    buildSuccessPrBody(testReport, beadsAudit) {
    ...
    buildFailurePrBody(testReport, beadsAudit) {
    ...
    getGateStatusHistory(gate) {
        return this.options.validationHistory.cycles
            .map((cycle) => {
            const result = cycle.gateResults.find((r) => r.gate === gate);
